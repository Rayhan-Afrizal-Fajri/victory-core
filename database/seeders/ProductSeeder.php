...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 3. AMBIL DATA MASTER MANUFACTURING WORKS (Jangan di-create ulang)
        // Ambil semua work yang sudah di-generate oleh ManufacturingWorkSeeder dan jadikan name sebagai key
        $works = ManufacturingWork::all()->keyBy('name');
        ...
        foreach ($productsToSeed as $prodData) {
            ...
            foreach ($prodData['works'] as $workName) {
                ...
                // Pastikan master work dengan nama tersebut ada di database
                if (isset($works[$workName])) {
                    ...
                    ProductManufacturingWork::create([
                        ...
                        // Menarik estimasi nilai dari ManufacturingWork
                        'min_estimate'          => 0, // Set 0 atau sesuaikan field min di tabel
                        'max_estimate'          => $workMaster->default_max_estimate, 
                        
                        'default_usage'         => 1,
                        'default_unit'          => $workMaster->default_unit ?? 'pcs',
